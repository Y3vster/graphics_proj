...
vec2 cmm_fn() {
    ...
    for (int k = 0; k < 10; k++) {
        ...
        vec2 p1 = unit_complex_fm_angle( n[k] * xrhombic2() + m[k] * yrhombic2()) +
                  unit_complex_fm_angle( m[k] * xrhombic2() + n[k] * yrhombic2());
        vec2 p2 = unit_complex_fm_angle(-n[k] * xrhombic2() - m[k] * yrhombic2()) +
                  unit_complex_fm_angle(-m[k] * xrhombic2() - n[k] * yrhombic2());
